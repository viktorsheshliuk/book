<?php
// Heading
$_['heading_title']    = '<span style="color:#43b02a;">Cyber</span>Store - SETTING ORDER PROCESING';

// Text
$_['text_module']      = 'Modules';
$_['text_success']     = 'Success: You have modified featured module!';
$_['text_edit']        = 'Edit SETTING ORDER PROCESING';

$_['entry_on_off_model_product']        			= 'On Off model product';
$_['entry_on_off_sku_product']        				= 'On Off SKU product';
$_['entry_on_off_upc_product']        				= 'On Off UPC product';
$_['entry_on_off_payment_method']        			= 'On Off Payment Method';
$_['entry_on_off_shipping_method']        			= 'On Off Shipping Method';

$_['entry_on_off_column_product']        			= 'On Off Column Product';
$_['entry_on_off_column_comment_manager']        	= 'On Off Column Comment Manager';
$_['entry_on_off_column_send_ttn_email']        	= 'On Off Column Sending TTN';
$_['entry_on_off_column_price_purchase']        	= 'On Off Column Price Purchase';
$_['entry_on_off_column_total_profit']        		= 'On Off Column Total Profit';
$_['entry_on_off_column_manager_process_orders']    = 'On Off Column Process Orders';
$_['entry_on_off_column_delivery_price']    		= 'On Off Column Cost of delivery';
$_['entry_on_off_column_build']    					= 'On Off Column The assembly';
$_['entry_on_off_column_rise_product']    			= 'On Off Column Climb';


$_['ttn_subject_text'] 								= 'Letter subject';
$_['ttn_subject_text_variables'] 					= 'It supports variables';
$_['entry_description_send_email_ttn'] 				= 'Template letters TTN';
...
<br/><b>~text_ttn~</b> - Waybill number
<br/><b>~order_id~</b> - Order number
<br/><b>~totals~</b> - order amount in current currency
<br/><b>~invoice_no~</b> - Account number      
<br/><b>~invoice_prefix~</b> - account prefix    
<br/><b>~store_id~</b> - id Store          
<br/><b>~store_name~</b> - Store name         
<br/><b>~store_url~</b> - url Store           			
<br/><b>~customer_id~</b> - id customer 
<br/><b>~firstname~</b> - Name
<br/><b>~lastname~</b> - Surname               
...
<br/><b>~payment_zone_id~</b> - id payment zone id
...
$_['error_name'] = 'Module name must contain between 3 and 64 characters!';
