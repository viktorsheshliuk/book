...
$_['text_new_greeting']         = 'Дякуємо за покупку в магазині %s . Ваше замовлення отримане і поступить в обробку найближчим часом';
...
$_['text_new_order_total']      = 'Разом';
$_['text_new_total']            = 'Разом';
$_['text_new_download']         = 'Після підтвердження оплати, товари для завантаження будуть доступні за посиланням:';
$_['text_new_comment']          = 'Коментар до вашого замовлення:';
$_['text_new_footer']           = 'Якщо у вас виникли будь-які запитання, дайте відповідь на це повідомлення.';
$_['text_update_subject']       = '%s - Оновлення замовлення %s';
$_['text_update_order']         = '№ замовлення:';
$_['text_update_date_added']    = 'Дата замовлення:';
$_['text_update_order_status']  = 'Ваше замовлення оновлене з наступним статусом:';
...
$_['text_update_footer']        = 'Якщо у вас виникли будь-які запитання, дайте відповідь на це повідомлення.';
